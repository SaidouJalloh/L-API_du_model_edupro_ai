...
# from utils import convert_duration_to_hours  # Importer la fonction utilitaire
...
#     # Définir les variables d'environnement si elles ne sont pas déjà définies
...
# app = Flask(__name__)
# CORS(app, origins=["https://mon-frontend.com"])  # Restriction aux requêtes du frontend autorisé
...
# # Cache pour éviter de re-demander les mêmes requêtes
# cache = {}
...
#             return jsonify({"cached": True, "data": cache[hash_input]})
...
#         # Stocker en cache pour éviter des requêtes inutiles
